...
def main(_):
  ...
  with tf.Graph().as_default():
    ...
    names_to_values, names_to_updates = slim.metrics.aggregate_metric_map({
        ...
        'Mean_absolute': tf.metrics.mean_absolute_error(labels,predictions),
        ...
        'Confusion_matrix': _get_streaming_metrics(predictions, labels, dataset.num_classes - FLAGS.labels_offset),
    })
