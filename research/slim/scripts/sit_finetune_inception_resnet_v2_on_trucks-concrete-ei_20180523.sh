...
PRETRAINED_CHECKPOINT_DIR=/home/sit/sit-machine-learning/data/models/detector_classificator/tf-slim/train/Trucks-concrete/inception_resnet_v2/all/model.ckpt-1000

# Where the training (fine-tuned) checkpoint and logs will be saved to.
TRAIN_DIR=/home/sit/sit-machine-learning/data/models/detector_classificator/tf-slim/train/Trucks-concrete-ei/${MODEL_NAME}

# Where the dataset is saved to.
DATASET_DIR=/home/sit/sit-machine-learning/data/databases/image/Trucks-concrete-ei
...
BAZEL=bazel
SLIM_DIR=/root/sit/src/models/research/slim

# Para que demore menos en cargar inicialmente
