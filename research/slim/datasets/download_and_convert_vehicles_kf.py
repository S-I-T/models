...
# The database prefix
_DB_PREFIX = 'vehicles_kf' 

# The URL where the database data can be downloaded.
...
def _get_dataset_filename(dataset_dir, split_name, shard_id):
	output_filename = (_DB_PREFIX + '_%s_%05d-of-%05d.tfrecord') % (
...
def run(dataset_dir):
	...
	if _dataset_exists(dataset_dir + '/tfrecords'):
	...
	num_validation = len(photo_filenames)*_PERC_VALIDATION//100
	...
	dataset_utils.write_label_file(labels_to_class_names, dataset_dir + '/tfrecords')

	#_clean_up_temporary_files(dataset_dir)
	print('\nFinished converting the ' + _DB_PREFIX + ' dataset!')
