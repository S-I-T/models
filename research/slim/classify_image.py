...
--num_classes 5 \
--infile /root/databases/Trucks/tfrecords/trucks_validation_00000-of-00005.tfrecord \
--model_name inception_v3 \
--checkpoint_path /root/models/tf-slim/train/Trucks/inception_v3/all/ \
--tfrecord

# Predict jpeg images, input file `a.txt` includes path to images.
find /root/databases/Trucks/images/ -maxdepth 2 -type f > images.txt
python classify_image.py \
--num_classes 5 \
--infile images.txt \
--model_name inception_v3 \
